"""
TD3+BC Evaluation Script
=========================
Evaluates a trained TD3BCAgent on PnPCounterToCab.

Usage
-----
python RoboCasa_Code_Aide/my_rl_scripts/eval_td3bc.py \
    --model_path checkpoints/exp7_td3bc_<timestamp>/td3bc_best.pt
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate a trained TD3+BC model")
    ...
    agent = TD3BCAgent.load(args.model_path)
    print(f"[INFO] alpha={agent.alpha}  gamma={agent.gamma}")
