"""
IQL Evaluation Script
======================
Usage
-----
python RoboCasa_Code_Aide/my_rl_scripts/eval_iql.py \
    --model_path checkpoints/exp8_iql_<timestamp>/iql_best.pt
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate a trained IQL model")
    ...
    agent = IQLAgent.load(args.model_path)
    print(f"[INFO] τ_expectile={agent.tau_expectile}  β={agent.beta}  γ={agent.gamma}")
