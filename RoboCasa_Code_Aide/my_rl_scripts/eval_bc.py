"""
Behavioral Cloning Evaluation Script
=====================================
Evaluates a trained BCAgent on PnPCounterToCab.

BC uses 16D robot proprioceptive observations (no object state), so it runs
against the raw robosuite env directly — not through GymWrapper.

Usage
-----
python RoboCasa_Code_Aide/my_rl_scripts/eval_bc.py \
    --model_path checkpoints/exp5_bc_<timestamp>/bc_best.pt
...
def main():
    ...
    agent = BCAgent.load(args.model_path)
